...
open class SimpleRangeView @JvmOverloads constructor(
    ...
    private companion object DefaultValues {
        ...
        val DEFAULT_ACTIVE_THUMB_LABEL_COLOR = Color.parseColor("#275160")
        val DEFAULT_FIXED_LABEL_COLOR = Color.parseColor("#C5C5C5")
        val DEFAULT_FIXED_THUMB_LABEL_COLOR = Color.parseColor("#275160")

        val DEFAULT_LINE_COLOR = Color.parseColor("#275160")
        val DEFAULT_ACTIVE_LINE_COLOR = Color.parseColor("#275160")
        val DEFAULT_FIXED_LINE_COLOR = Color.parseColor("#F7F7F7")
        val DEFAULT_TICK_COLOR = Color.parseColor("#275160")
        val DEFAULT_ACTIVE_TICK_COLOR = Color.parseColor("#275160")
        val DEFAULT_FIXED_TICK_COLOR = Color.parseColor("#DCDCDC")
        val DEFAULT_ACTIVE_THUMB_COLOR = Color.parseColor("#275160")
        val DEFAULT_ACTIVE_FOCUS_THUMB_COLOR = DEFAULT_ACTIVE_THUMB_COLOR
        val DEFAULT_FIXED_THUMB_COLOR = Color.parseColor("#275160")
